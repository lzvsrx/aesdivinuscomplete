...
A partir da versao `v0.1.15`, os artefatos publicados no GitHub Releases sao baseados no projeto Godot em `godot/`. O GDD mestre V2 define a direcao oficial como RPG tatico 3D single-player por turnos, com exploracao em terceira pessoa, combate em arenas taticas 3D e arsenal jogavel com lojas/oficina.

## Artefatos por plataforma

- Windows: `Aes-Divinus-Godot-Windows-x64-0.1.15.zip`
- Linux minimo: `Aes-Divinus-Godot-Linux-x64-0.1.15.zip`
- Linux Universal: `Aes-Divinus-Godot-Linux-Universal-x64-0.1.15.zip` / `.tar.gz`
- Linux Debian/Ubuntu/Mint: `Aes-Divinus-Godot-Linux-Debian-Ubuntu-Mint-x64-0.1.15.zip` / `.tar.gz`
- Linux Fedora/RHEL/openSUSE: `Aes-Divinus-Godot-Linux-Fedora-RHEL-openSUSE-x64-0.1.15.zip` / `.tar.gz`
- Linux Arch/Manjaro: `Aes-Divinus-Godot-Linux-Arch-Manjaro-x64-0.1.15.zip` / `.tar.gz`
- Linux Steam Deck: `Aes-Divinus-Godot-Linux-SteamDeck-x64-0.1.15.zip` / `.tar.gz`
- Android: `Aes-Divinus-Godot-Android-debug.apk`
- iOS/macOS de assinatura: `Aes-Divinus-Godot-Project-0.1.15.zip`
- Executadores: `Aes-Divinus-Executadores-0.1.15.zip`
- Verificacao: `SHA256SUMS-Godot-0.1.15.txt`
