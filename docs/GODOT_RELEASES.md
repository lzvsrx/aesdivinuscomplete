...
A partir da versao `v0.1.16`, os artefatos publicados no GitHub Releases sao baseados no projeto Godot em `godot/`. O GDD mestre V2 define a direcao oficial como RPG tatico 3D single-player por turnos, com exploracao em terceira pessoa, combate em arenas taticas 3D e arsenal jogavel com lojas/oficina.

## Artefatos por plataforma

- Windows: `Aes-Divinus-Godot-Windows-x64-0.1.16.zip`
- Linux minimo: `Aes-Divinus-Godot-Linux-x64-0.1.16.zip`
- Linux Universal: `Aes-Divinus-Godot-Linux-Universal-x64-0.1.16.zip` / `.tar.gz`
- Linux Debian/Ubuntu/Mint: `Aes-Divinus-Godot-Linux-Debian-Ubuntu-Mint-x64-0.1.16.zip` / `.tar.gz`
- Linux Fedora/RHEL/openSUSE: `Aes-Divinus-Godot-Linux-Fedora-RHEL-openSUSE-x64-0.1.16.zip` / `.tar.gz`
- Linux Arch/Manjaro: `Aes-Divinus-Godot-Linux-Arch-Manjaro-x64-0.1.16.zip` / `.tar.gz`
- Linux Steam Deck: `Aes-Divinus-Godot-Linux-SteamDeck-x64-0.1.16.zip` / `.tar.gz`
- Android: `Aes-Divinus-Godot-Android-debug.apk`
- iOS/macOS de assinatura: `Aes-Divinus-Godot-Project-0.1.16.zip`
- Executadores: `Aes-Divinus-Executadores-0.1.16.zip`
- Verificacao: `SHA256SUMS-Godot-0.1.16.txt`
...
- O Arsenal agora abre uma tela propria de compras, vendas, equipamento e criacao de itens.
- Cada item mostra tipo, pedra vinculada, descricao, estatisticas, preco e receita de oficina.
- Compras, vendas, criacao, equipamento e transacoes entram no autosave.
- Modelos 3D procedurais receberam detalhes de roupa, cabelo, pedra Aes, acabamento, armas, ferramentas e props de ambiente.
- O modelo usado dentro da arena de missao agora segue o preview do personagem, com corpo, rosto, olhos, cabelo, barba, paleta, arma e pedra visivel.
