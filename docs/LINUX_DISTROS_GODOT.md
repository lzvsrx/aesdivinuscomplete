...
- `Aes-Divinus-Godot-Linux-x64-0.1.16.zip`: pacote minimo com executavel e `.pck`.
- `Aes-Divinus-Godot-Linux-Universal-x64-0.1.16.zip` e `.tar.gz`: qualquer distro Linux `x86_64` moderna.
- `Aes-Divinus-Godot-Linux-Debian-Ubuntu-Mint-x64-0.1.16.zip` e `.tar.gz`: Debian, Ubuntu, Linux Mint, Pop!_OS e derivados.
- `Aes-Divinus-Godot-Linux-Fedora-RHEL-openSUSE-x64-0.1.16.zip` e `.tar.gz`: Fedora, RHEL, AlmaLinux, Rocky Linux, openSUSE e derivados.
- `Aes-Divinus-Godot-Linux-Arch-Manjaro-x64-0.1.16.zip` e `.tar.gz`: Arch Linux, Manjaro, EndeavourOS e derivados.
- `Aes-Divinus-Godot-Linux-SteamDeck-x64-0.1.16.zip` e `.tar.gz`: SteamOS / Steam Deck.
- `Aes-Divinus-Godot-Linux-Distros-0.1.16.txt`: resumo de compatibilidade.

## Como rodar

```bash
tar -xzf Aes-Divinus-Godot-Linux-Universal-x64-0.1.16.tar.gz
cd Aes-Divinus-Godot-Linux-Universal-x64-0.1.16
